...
<section class="module">
	<div class="container"
		...
		<form action="/product/write/update" id="form" class="form" method="post" enctype="multipart/form-data">
		<input type="hidden" name="_method" value="put"/>
			...
			<div>
			    <div class="d-flex flex-column align-items-center text-center p-3 py-5"
			        ...
			        <label for="fileInput" style="">썸네일 (이미지를 추가하지 않으시면 원래 이미지가 들어갑니다.)</label>
...
<input type="number" name="price" min="0" value="${product.price}" step="1000" id="price" placeholder="Enter price" />
			...
			<div class="register-form">
				...
				<textarea id="summernote" style="width: 100%;" name="description">${product.description}</textarea>
			</div>
			<br> 
			<br> 
			<br> 
