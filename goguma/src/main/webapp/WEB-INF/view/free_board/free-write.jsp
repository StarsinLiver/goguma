        ...
        <div class="row">
            <form class="row">
                ...
                <div class="mb-3 col-md-3">
                    <label for="mainCategorySelect" class="form-label">카테고리설정</label>
                    <select class="form-select" id="mainCategorySelect" style="width:auto;">
                        <option value="1">메인 카테고리 1</option>
                        <option value="2">메인 카테고리 2</option>
                        <option value="3">메인 카테고리 3</option>
                    </select>
                </div>
                <!-- 서브 카테고리 선택 셀렉트 박스 -->
                <div class="mb-3 col-md-3">
                    <label for="subCategorySelect" class="form-label"></label>
                    <select class="form-select" id="subCategorySelect" style="width:auto;margin-left: -80px;margin: 5px 0 0 -80px;">
                        <option value="1">서브 카테고리 1</option>
                        <option value="2">서브 카테고리 2</option>
                        <option value="3">서브 카테고리 3</option>
                    </select>
                </div>
                <!-- 제목 입력 폼 -->
