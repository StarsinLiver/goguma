...
<div class="user-page"
	...
	<div class="payment-container" style="width: 100%; height: 100%">
		<h4 class="user-page-title">게시판 수정하기</h4>
		<div class="col-sm-12">
							...
							<tr>
								...
								<td>
									<div class="form-floating mb-3">
									  <input type="email" class="form-control"  placeholder="name@example.com" style="font-size: 2rem; padding: 0;">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="form-check-inline form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="margin-left:-11.5em; margin-top: -2px">
									  <label class="form-check-label" for="flexSwitchCheckDefault" style="float: left;">카드형식</label>
									</div>
									<div class="form-check-inline form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="margin-left:-24.5em; margin-top:-6px" disabled>
									  <label class="form-check-label" for="flexSwitchCheckDefault" style="float: left;">리스트형식 (disabled)</label>
									</div>
								</td>
							</tr>
							<tr>
