							...
							<tr>
								...
								<td>
									<div class="form-check-inline form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="margin-left: -14.5em; margin-top: 12px">
									  <label class="form-check-label" for="flexSwitchCheckDefault" style="float: left;">카드형식</label>
									</div>
									<div class="form-check-inline form-switch">
									  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" style="margin-left:-24.5em; margin-top: 12px" disabled>
