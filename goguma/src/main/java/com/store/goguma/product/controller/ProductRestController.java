...
public class ProductRestController {
	...
	public ResponseEntity<?> searchProduct(
		...
		try {
			...
			PageRes<ProductSearchDto> pageRes = productService.searchAll(search, searchAddress, lowPrice, highPrice, sortWishList, sortChatRoom, sortLowPrice, sortHighPrice, pageReq);
